            ...
            <div class="row justify-content-around pt-md-5">
                ...
                <div class="col-12 col-md-10 col-xl-5 col-xxl-3 exo mx-md-3 mx-xxl-5 my-2 my-md-5">
                    <article class="d-flex flex-column justify-content-between py-3 px-1 py-md-4 px-md-4">
                        ...
                        <div class="text">
                            <ul>
                                <li class="mb-2">Créer un tableau <strong>months</strong> et l'initialiser avec les mois de l'année.</li>
                            </ul>
                        </div>
                ...
                <div class="col-12 col-md-10 col-xl-5 col-xxl-3 exo mx-md-3 mx-xxl-5 my-2 my-md-5">
                    <article class="d-flex flex-column justify-content-between py-3 px-1 py-md-4 px-md-4">
                        ...
                        <div class="text">
                            <ul>
                                <li class="mb-2">Avec le tableau de l'exercice 1, afficher la valeur de la troisième ligne de ce tableau.</li>
                            </ul>
                        </div>
                        <div class="d-flex justify-content-center">
                ...
                <div class="col-12 col-md-10 col-xl-5 col-xxl-3 exo mx-md-3 mx-xxl-5 my-2 my-md-5">
                    <article class="d-flex flex-column justify-content-between py-3 px-1 py-md-4 px-md-4">
                        ...
                        <div class="text">
                            <ul>
                                <li class="mb-2">Avec le tableau de l'exercice 1, afficher la valeur de l'index 5.</li>
                            </ul>
                        </div>
                        <div class="d-flex justify-content-center">
                ...
                <div class="col-12 col-md-10 col-xl-5 col-xxl-3 exo mx-md-3 mx-xxl-5 my-2 my-md-5">
                    <article class="d-flex flex-column justify-content-between py-3 px-1 py-md-4 px-md-4">
                        ...
                        <div class="text">
                            <ul>
                                <li class="mb-2">Avec le tableau de l'exercice 1, modifier le mois de <em>aout</em> pour lui retirer l'accent.</li>
                            </ul>
                        </div>
                        <div class="d-flex justify-content-center">
                ...
                <div class="col-12 col-md-10 col-xl-5 col-xxl-3 exo mx-md-3 mx-xxl-5 my-2 my-md-5">
                    <article class="d-flex flex-column justify-content-between py-3 px-1 py-md-4 px-md-4">
                        ...
                        <div class="text">
                            <ul>
                                <li class="mb-2">Créer un tableau associatif avec comme index le numéro des départements des Hauts de France et en valeur leur nom.</li>
                            </ul>
                        </div>
                        <div class="d-flex justify-content-center">
                ...
                <div class="col-12 col-md-10 col-xl-5 col-xxl-3 exo mx-md-3 mx-xxl-5 my-2 my-md-5">
                    <article class="d-flex flex-column justify-content-between py-3 px-1 py-md-4 px-md-4">
                        ...
                        <div class="text">
                            <ul>
                                <li class="mb-2">Avec le tableau de l'exercice 5, afficher la valeur de l'index 59.</li>
                            </ul>
                        </div>
                        <div class="d-flex justify-content-center">
                            <dialog><img src="../../public/assets/img/fondamentaux/tableaux/6.png" class="img-fluid" alt="Code de l'exercice 6"></dialog>
                            <button type="button" class="btn showCode d-block shadow px-5 py-2 mt-3">Voir le
                                code</button>
                        </div>
                    </article>
                ...
                <div class="col-12 col-md-10 col-xl-5 col-xxl-3 exo mx-md-3 mx-xxl-5 my-2 my-md-5">
                    <article class="d-flex flex-column justify-content-between py-3 px-1 py-md-4 px-md-4">
                        ...
                        <div class="text">
                            <ul>
                                <li class="mb-2">Avec le tableau de l'exercice 5, ajouter la ligne correspondant au département de la ville de Reims.</li>
                            </ul>
                        </div>
                        <div class="d-flex justify-content-center">
                            <dialog><img src="../../public/assets/img/fondamentaux/tableaux/7.png" class="img-fluid" alt="Code de l'exercice 7"></dialog>
                            <button type="button" class="btn showCode d-block shadow px-5 py-2 mt-3">Voir le
                                code</button>
                        </div>
                    </article>
                ...
                <div class="col-12 col-md-10 col-xl-5 col-xxl-3 exo mx-md-3 mx-xxl-5 my-2 my-md-5">
                    <article class="d-flex flex-column justify-content-between py-3 px-1 py-md-4 px-md-4">
                        ...
                        <div class="text">
                            <ul>
                                <li class="mb-2">Avec le tableau de l'exercice 1 et une boucle, afficher toutes les valeurs de ce tableau.</li>
                            </ul>
                        </div>
                        <div class="d-flex justify-content-center">
                            <dialog><img src="../../public/assets/img/fondamentaux/tableaux/8.png" class="img-fluid" alt="Code de l'exercice 8"></dialog>
                            <button type="button" class="btn showCode d-block shadow px-5 py-2 mt-3">Voir le
                                code</button>
                        </div>
                    </article>
                ...
                <div class="col-12 col-md-10 col-xl-5 col-xxl-3 exo mx-md-3 mx-xxl-5 my-2 my-md-5">
                    <article class="d-flex flex-column justify-content-between py-3 px-1 py-md-4 px-md-4">
                        ...
                        <div class="text">
                            <ul>
                                <li class="mb-2">Avec le tableau de l'exercice 5, afficher toutes les valeurs de ce tableau.</li>
                            </ul>
                        </div>
                        <div class="d-flex justify-content-center">
                            <dialog><img src="../../public/assets/img/fondamentaux/tableaux/9.png" class="img-fluid" alt="Code de l'exercice 9"></dialog>
                            <button type="button" class="btn showCode d-block shadow px-5 py-2 mt-3">Voir le
                                code</button>
                        </div>
                    </article>
                ...
                <div class="col-12 col-md-10 col-xl-5 col-xxl-3 exo mx-md-3 mx-xxl-5 my-2 my-md-5">
                    <article class="d-flex flex-column justify-content-between py-3 px-1 py-md-4 px-md-4">
                        ...
                        <div class="text">
                            <ul>
                                <li class="mb-2">Avec le tableau de l'exercice 5, afficher toutes les valeurs de ce tableau ainsi que les clés associés.</li>
                                <li class="mb-2">Cela pourra être, par exemple, de la forme : <em>Le département + nom du département + a le numéro + numéro du département</em>.</li>
                            </ul>
                        </div>
                        <div class="d-flex justify-content-center">
                            <dialog><img src="../../public/assets/img/fondamentaux/tableaux/10.png" class="img-fluid" alt="Code de l'exercice 10"></dialog>
                            <button type="button" class="btn showCode d-block shadow px-5 py-2 mt-3">Voir le
                                code</button>
                        </div>
                    </article>
